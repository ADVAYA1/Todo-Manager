...
const TrelloBoard = () => {
  ...
  const [showAddTaskModal, setShowAddTaskModal] = useState(false); // New state for add task modal
    ...
    <div className="p-4">
      <div className="mb-4 flex justify-between items-center">
        <button
          ...
          onClick={() => setShowAddTaskModal(true)} // Open modal instead of adding task directly
        >
          Add Task
        </button>
        <input
